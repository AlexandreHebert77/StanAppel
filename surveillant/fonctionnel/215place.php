<!doctype html>
 ...
 <p><?php
    ...
    while ($row = $statement->fetch()) {
     ...
     ?>
  <a class="btn btn-success btn-lg btn-block" href="215Present.php" role="button"  style="margin-top:40px; margin-bottom:20px">Present</a>
 <a class="btn btn-danger btn-lg btn-block" href="215Retard.php" role="button"  style="margin-top:20px">Retardataire</a>
